"use client";
import { GetToken } from "@/app/components/firebase/firebase";
import { CreateSession } from "@/app/components/firebase/Sessions";

export default function LoginPage() {
  return (
    <div className="h-screen grid">
      <div className="flex flex-col  items-center">
        <h1 className="mb-8 text-xl">Hi, You Need to Login Using Google</h1>
      </div>
      <div className="flex flex-col items-center">
