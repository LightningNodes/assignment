    ...
    >
      <TextField
        ...
        InputProps={{
          sx: {
            '& fieldset': {
              borderColor: 'whitesmoke', // Normal border color
            },
            '&:hover fieldset': {
              color: '#ffffff',
              boxShadow: '0 0 8px #ff6601',
            },
      ...
      />
        ...
        <div className={styles.footer}>
          ...
          <button className="login-button" disabled={submitButtonDisabled} onClick={handleSubmission}>
